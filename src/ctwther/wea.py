...
# 내일모레 단어 인식이 부정확할시 사용, spacy및 googletrans에서 인식 불가 경우 발생 
t_ref = ['내일모레','모레']
...
# OpenWeatherMap api 호출 및 일자에 따른 날씨 정보 정리
...
# OpenWeatherMap api 호술시 도시 정보 입력 실패
